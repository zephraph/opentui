...
export class OptimizedBuffer {
  ...
  public drawText(text: string, x: number, y: number, fg: RGBA, bg?: RGBA, attributes: number = 0): void {
    if (this.useFFI) {
      this.drawTextFFI(text, x, y, fg, bg, attributes)
    } else {
      this.drawTextLocal(text, x, y, fg, bg, attributes)
    }
  }
  ...
  public drawStyledTextFragment(fragment: Fragment, x: number, y: number, defaultFg?: RGBA, defaultBg?: RGBA): void {
    this.drawStyledTextFragmentLocal(fragment, x, y, defaultFg, defaultBg)
  }
  ...
  public drawStyledTextFragmentLocal(
    ...
    this.drawStyledTextLocal(fragment.toStyledText(), x, y, defaultFg, defaultBg)
  }
